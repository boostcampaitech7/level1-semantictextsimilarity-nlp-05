...
class MultitaksModel(pl.LightningModule):
    ...
    def forward(self, x):
        ...
        return {"similarity": similarity.squeeze(), "classification": classification}
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log(
            "val_pearson",
            self.similarity_metric(logits["similarity"], similarity_y.squeeze()),
        )
        self.log(
            "classification_val_acc",
            self.classification_metric(classification_pred, classification_y),
        )
